...
TABLE_NAME="test5_fk"
echo "
CREATE TABLE parent_1 (     id INT NOT NULL,     PRIMARY KEY (id) ) ENGINE=INNODB;
CREATE TABLE parent_2 (     id INT NOT NULL,     second_id INT NOT NULL,     PRIMARY KEY (id, second_id) ) ENGINE=INNODB;
CREATE TABLE parent_3 (     id INT NOT NULL,     PRIMARY KEY (id) ) ENGINE=INNODB;
CREATE TABLE parent_4 (     id INT NOT NULL,     PRIMARY KEY (id) ) ENGINE=INNODB;
CREATE DATABASE IF NOT EXISTS test2;
CREATE TABLE test2.parent_5 (     id INT NOT NULL,     PRIMARY KEY (id) ) ENGINE=INNODB;
INSERT INTO parent_1 VALUES(1);
INSERT INTO parent_2 VALUES(1, 1);
INSERT INTO parent_3 VALUES(1);
INSERT INTO parent_4 VALUES(1);
INSERT INTO test2.parent_5 VALUES(1);" | ${MYSQL} ${MYSQL_ARGS} test
...
echo "CREATE table test.${TABLE_NAME} (
 ...
 CONSTRAINT child_ibfk_1 FOREIGN KEY (parent1_id) REFERENCES parent_1 (id) ON UPDATE RESTRICT ON DELETE RESTRICT,
 CONSTRAINT child_ibfk_2 FOREIGN KEY (parent2_id, parent2_second_id) REFERENCES parent_2 (id, second_id) ON UPDATE CASCADE ON DELETE CASCADE ,
 CONSTRAINT child_ibfk_3 FOREIGN KEY (parent3_id) REFERENCES parent_3 (id) ON UPDATE SET NULL ON DELETE SET NULL,
 CONSTRAINT child_ibfk_4 FOREIGN KEY (parent4_id) REFERENCES parent_4 (id) ON UPDATE NO ACTION ON DELETE NO ACTION,
 CONSTRAINT child_ibfk_5 FOREIGN KEY (parent5_id) REFERENCES test2. parent_5 (id) ON UPDATE SET DEFAULT ON DELETE SET DEFAULT
